...
#define BCXX_PWREN_HIGH		GPIO_SetBits(GPIOA,GPIO_Pin_8)
#define BCXX_PWREN_LOW		GPIO_ResetBits(GPIOA,GPIO_Pin_8)
...
unsigned char bcxx_set_AT_LIFETIME(unsigned short time);
